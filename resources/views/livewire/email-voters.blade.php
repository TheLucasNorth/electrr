<div>
    ...
    @if(count($voters)>0)
        ...
        <div class="flex flex-col mt-4">
                        ...
                        <table class="min-w-full divide-y divide-gray-200" id="voters-table">
                            ...
                            @foreach($voters as $voter)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap"><input type="checkbox" wire:model="selected.{{$voter->id}}" style="transform: scale(2); zoom: 2; -ms-transform: scale(2); -moz-transform: scale(2); -webkit-transform: scale(2); -o-transform: scale(2);"></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
            ...
            <div class="mt-4 flex-wra flex">
                <livewire:send-emails :election="$election"/>
                <livewire:send-reminders :election="$election"/>
            </div>
    @else
        <p>You have not added any email voters to this election.</p>
    @endif
    <hr class="mt-4 mb-2">
    <div class="mt-4">
        <livewire:add-email-voters :election="$election"/>
    </div>
</div>
