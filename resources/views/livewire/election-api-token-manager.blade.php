<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="description">
            <p class="text-gray-600">API tokens allow third-party services to authenticate with our application on your behalf. API tokens created here will be able to manage your election in the ways you select.</p>
        </x-slot>
    ...
    @if ($this->election->tokens->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    {{ __('You may delete or modify any of your existing tokens if they are no longer needed.') }}
                </x-slot>

                <!-- API Token List -->
                <x-slot name="content">
                    <div class="space-y-6">
                        @foreach ($this->election->tokens->sortBy('name') as $token)
